import socket
import ssl
from ssl import wrap_socket, CERT_NONE, PROTOCOL_TLSv1_2, SSLError
...
CA_CERT_PATH = './GeoTrustGlobalCA.pem'
...
if __name__ == '__main__':
	...
	ssl_socket = ssl_wrap_socket(client_sock, ssl_version=PROTOCOL_TLSv1_2, 
		cert_reqs=ssl.CERT_REQUIRED, ca_certs=CA_CERT_PATH, server_hostname=hostname)
